            ...
            <ul id="left2" class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a target="iframe_context"  href="doCus?action=queryCustomer&pageNumber=1">查询顾客</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a class="layui-icon" href="javascript:;" style="color:#9FC105">&#xe621;&nbsp;&nbsp;分类管理</a>
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doBig?action=queryBig&pageNumber=1">大分类管理</a></dd>
                        <dd><a target="iframe_context" href="doSmall?action=querySmall&pageNumber=1">小分类管理</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a target="iframe_context" href="doAnn?action=queryAnn&pageNumber=1">查询公告</a></dd>
                        <dd><a target="iframe_context" href="page/addAnn.jsp">添加公告</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
