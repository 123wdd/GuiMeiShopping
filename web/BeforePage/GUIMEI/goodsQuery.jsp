...
<head lang="en">
    ...
    <script>
      	...
      	$(function(){
			...
			var action="getgoodsManagerVagueQurey";
      	...
      	function Reload (){
			...
			$("[name='pagesize']").change(function(){
				...
				url = Path+"?action="+action+"&pageNum="+pageNum+"&pageSize="+pageSize;
				show(url);
			});
  		...
  		var url = Path+"?action="+action+"&pageNum="+pageNum+"&pageSize="+pageSize;
  		show(url);
