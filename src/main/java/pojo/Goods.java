...
public class Goods {
  ...
  private long goodsSellid;
  public long getGoodsSellid() {
    return goodsSellid;
  }

  public void setGoodsSellid(long goodsSellid) {
    this.goodsSellid = goodsSellid;
  }



  public String getGoodsSellId() {
    return goodsSellId;
  }

  public void setGoodsSellId(String goodsSellId) {
    this.goodsSellId = goodsSellId;
  }

  private  String goodsSellId;

  public Goods() {
  }

  public Goods(long id, String goodsName, long goodsSmalId, double goodsMoney, long goodsNumber, String goodsImage, double goodsCarriage, long goodsType, long goodsDiscId, String goodsSellId) {
    this.id = id;
